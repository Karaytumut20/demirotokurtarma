      ...
      <div className="container mx-auto px-6 py-24 flex flex-col lg:flex-row gap-16">
         ...
         <div className="lg:w-1/3 space-y-8">
            <div className="bg-[#0f172a] text-white p-8 rounded-2xl shadow-xl relative overflow-hidden">
                ...
                <a href="tel:905469514925" className="block w-full bg-white text-[#0f172a] text-center py-4 rounded-xl font-black hover:bg-blue-50 transition-all mb-4 relative z-10">
                    0546 951 49 25
                </a>
