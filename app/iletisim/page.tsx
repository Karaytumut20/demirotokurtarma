                ...
                <div className="space-y-8">
                    ...
                    <div className="flex gap-6 items-start">
                        ...
                        <div>
                            ...
                            <span className="text-slate-600">info@demirotokurtarma.com</span>
                        </div>
                    </div>
                </div>
            </div>

            <div className="lg:w-1/2 bg-slate-200 h-[400px] lg:h-auto">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3015.688868888!2d29.35!3d40.85!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDUxJzAwLjAiTiAyOcKwMjEnMDAuMCJF!5e0!3m2!1str!2str!4v1620000000000!5m2!1str!2str"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
