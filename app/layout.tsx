...
export const metadata: Metadata = {
  ...
  description:
    "Kocaeli Çayırova, Şekerpınar ve Gebze bölgesinde 7/24 acil oto kurtarma, yol yardım ve çekici hizmeti. En yakın çekici 15 dakikada yanınızda.",
  keywords: [
    "oto çekici",
    "yol yardım",
    "gebze çekici",
    "çayırova oto kurtarma",
    "şekerpınar çekici",
    "demir oto kurtarma",
  ],
  ...
  openGraph: {
    ...
    // modifiedTime satırı hata verdiği için kaldırıldı (website tipinde desteklenmez)
  },
};
