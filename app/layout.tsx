...
export const metadata: Metadata = {
  ...
  title: {
    default: "Demir Oto Kurtarma | Çayırova, Gebze, Şekerpınar,Tuzla Çekici",
    template: "%s | Demir Oto Kurtarma",
  },
  description:
    "Kocaeli Çayırova, Şekerpınar Gebze ve Tuzla bölgesinde 7/24 acil oto kurtarma, yol yardım ve çekici hizmeti. En yakın çekici 15 dakikada yanınızda.",
  keywords: [
    "oto çekici",
    "yol yardım",
    "gebze çekici",
