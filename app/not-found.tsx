    ...
    <div className="h-screen flex flex-col items-center justify-center bg-slate-950 text-white text-center px-4 relative overflow-hidden">
      ...
      <div className="relative -mt-16 z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:905013338042" className="bg-orange-600 text-white px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-orange-700 transition-colors">
