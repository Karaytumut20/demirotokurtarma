      ...
      <div className="relative z-30 -mt-16 sm:-mt-24 container mx-auto px-4 sm:px-6 mb-16 sm:mb-24">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-12 border border-slate-100 max-w-4xl mx-auto relative overflow-hidden">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-3xl font-black text-[#0f172a]">
              Ne Kadar Öderim?
            </h2>
            <p className="text-xs sm:text-base text-slate-500 mt-1 sm:mt-2">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            ...
            <div className="space-y-4 sm:space-y-6 text-gray-600 text-base sm:text-lg leading-relaxed">
              <p>
                ...
                bölgesinin en köklü kurtarma firmalarından biriyiz. Sektördeki
                15 yıllık tecrübemizle, yolda kalan binlerce sürücüye Hızır gibi
                yetiştik.
              </p>
              <p>
                Sıradan bir çekici hizmetinden fazlasını sunuyoruz. Aracınızın
                kıymetini biliyor, kendi aracımız gibi özenle taşıyoruz. Tüm
                operasyonlarımızda{" "}
                <strong className="text-slate-900">Axa Sigorta</strong>{" "}
                güvencesi sunarak, olası riskleri sıfıra indiriyoruz.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-8">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 font-bold text-slate-800 text-sm sm:text-base"
                >
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 relative">
            ...
            <div className="relative h-[350px] sm:h-[450px] lg:h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl border-4 border-white transform rotate-1 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="absolute bottom-0 left-0 p-4 sm:p-8 w-full pointer-events-none">
                ...
                <p className="text-white font-black text-base sm:text-xl mb-1">
                  Bölgenin Lideri
                </p>
                ...
                <div className="hidden sm:flex items-center gap-2">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-8 h-8 rounded-full bg-slate-200 border-2 border-slate-800 flex items-center justify-center text-[10px] font-bold overflow-hidden"
                      >
