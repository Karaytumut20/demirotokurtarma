  ...
  return (
    <section className="py-20 bg-[#0f172a] relative overflow-hidden text-center">
        <div className="container mx-auto px-6 relative z-10">
            ...
            <a href="tel:905539820188" className="inline-flex items-center gap-3 bg-white text-[#0f172a] px-10 py-5 rounded-full font-black text-2xl hover:scale-105 transition-transform shadow-2xl">
